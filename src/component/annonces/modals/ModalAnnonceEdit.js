                    ...
                    <div class="modal-body p-0">
                        <div class="card p-3 p-lg-4">
                            ...
                            <div class="text-center text-md-center mb-4 mt-md-0">
                                <h1 class="mb-0 h4"> Modifier   Annonce </h1>
                            </div>
                            <form action="#" class="mt-4" onSubmit={handleSubmit}>
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input defaultValue={data.titre} type="text" name="titre" onChange={handleChange} class="form-control" placeholder="nom de l'offre de l'offre..........." id="username" autofocus required />
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                            ...
                                            <select class="form-select" onChange={handleChange} name="entreprise" aria-label="Default select example">

                                                {
                                                    dataEntreprise.map((item) => {
                                                        return (<option selected={item.full_name ? true : false} value={item.full_name}>{item.full_name.toUpperCase()}</option>
                                                        )
                                                    })
                                                }
                                            </select>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <textarea defaultValue={data.description} name="description" onChange={handleChange} placeholder="nom complet .............." class="form-control" id="name" required />
                                        </div>
                                    </div>
