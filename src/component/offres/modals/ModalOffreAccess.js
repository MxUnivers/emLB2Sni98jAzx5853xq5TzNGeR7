...
import { OffreActionUnBlockedRequest } from '../../../actions/others/OffreAction';

const ModalOffreAccess = ({ data }) => {
    ...
    const handleSubmit = (event) => {
        ...
        dispatch(OffreActionUnBlockedRequest(data._id));
    };
    return (
                    ...
                    <div class="modal-body p-0">
                        <div class="card p-3 p-lg-4">
                            ...
                            <div class="text-center text-md-center mb-4 mt-md-0">
                                <h1 class="mb-0 h4">Débloquer cette offre </h1>
                            </div>
...
export default ModalOffreAccess;