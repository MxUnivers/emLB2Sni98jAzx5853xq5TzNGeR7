...
import { MemberBlockedRequest } from '../../../actions/others/MemberAction';

const ModalMemberStop = ({data}) => {
    ...
    const handleSubmit = (event) => {
        ...
        dispatch(MemberBlockedRequest(data._id));
    }
                    ...
                    <div class="modal-body p-0">
                        <div class="card p-3 p-lg-4">
                            ...
                            <div class="text-center text-md-center mb-4 mt-md-0">
                                <h1 class="mb-0 h4">Bloquer cet membre </h1>
                            </div>
...
export default ModalMemberStop;