...
import {  typeStatut } from '../../../config/ListApi';
                    ...
                    <div class="modal-body p-0">
                        <div class="card p-3 p-lg-4">
                            ...
                            <div class="text-center text-md-center mb-4 mt-md-0">
                                <h1 class="mb-0 h4"> Modification du membre </h1>
                            </div>
                            <form action="#" class="mt-4">
                                ...
                                <div class="d-grid">
                                    <button type="submit" class="btn btn-gray-800"> Confirmer modification</button>
                                </div>
                            </form>
                        </div>
                    </div>
