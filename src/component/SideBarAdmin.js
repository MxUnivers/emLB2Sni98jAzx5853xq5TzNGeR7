...
import { itemsSidebar } from '../config/nametitle'
import { routing } from '../config/routing'
import { localvalue } from '../config/localvalue'
import { useDispatch, useSelector } from 'react-redux'
import { AdministratorDisconnectRequest } from '../actions/auth/authAdministraorAction'
...
const SideBarAdmin = () => {
    ...
    const handleSubmit = (event) => {
        ...
        dispatch(AdministratorDisconnectRequest(id));
    };
                    ...
                    <li class="nav-item">
                        <span
                            ...
                            <span>
                                ...
                                <span class="sidebar-text">Gestions</span>
                            </span>
