...
const AcceptedCandidatApplications = () => {
  ...
  return (
    <div className="container mx-auto py-8">
      <div className="bg-green-500 py-4  my-2 rounded-lg">
        <h1 className="text-2xl font-bold text-white text-center">Candidatures Accepetées</h1>
      </div>
...
export default AcceptedCandidatApplications