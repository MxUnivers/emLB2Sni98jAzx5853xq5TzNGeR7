...
const RejectedCandidatApplications = () => {
    const applications = [
    ...
    return (
        <div className="container mx-auto py-8">
            <div className="bg-red-300 py-4  my-2 rounded-lg">
                <h1 className="text-2xl font-bold text-white text-center">Candidatures rejetées</h1>
            </div>
...
export default RejectedCandidatApplications;