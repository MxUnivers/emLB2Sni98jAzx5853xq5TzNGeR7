    ...
    return (
        ...
        <article class=" transition duration-350 ease-in-out p-5">
            ...
            >
                <a href="#" class="flex-shrink-0 group block">
                    <div class="flex items-center">
                        <div>
                            <img class="inline-block h-10 w-10 rounded-full" src={item.customerPhoto} alt="" />
                        </div>
                        <div class="ml-3">
                            <p class="text-base leading-6 font-medium text-black">
                                {item.customerName}
                                <span class="text-sm leading-5 mx-1 font-medium text-gray-400 group-hover:text-gray-300 transition ease-in-out duration-150">
            ...
            <div class="pl-16 pb-5">
                <p class="text-base width-auto font-medium text-black flex-shrink line-clamp-2 hover:underline">
                    {item.title}
                    <a href="#" class="text-blue-400"></a>
                </p>
...

                {
                    ...
                    <div class="flex-1 flex items-center text-black text-xs text-gray-400 hover:text-blue-400 transition duration-350 ease-in-out">
                    ...
                    <div class="flex-1 flex items-center text-black text-xs text-gray-400 hover:text-green-400 transition duration-350 ease-in-out">
                        <svg viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5 mr-2">
                            <g>
                    ...
                    <div class="flex-1 flex items-center text-black text-xs text-gray-400 hover:text-red-600 transition duration-350 ease-in-out">
                        <svg viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5 mr-2">
                            <g>
