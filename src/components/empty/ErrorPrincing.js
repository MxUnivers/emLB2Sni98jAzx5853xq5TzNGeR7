    ...
    return (
        <div class="w-full h-screen flex flex-col items-center justify-center">
            ...
            <div class="flex flex-col items-center justify-center">
                <p class="text-5xl md:text-6xl lg:text-7xl font-bold tracking-wider text-gray-600 mt-8"></p>
                ...
                <a href={`/${route}`} class="md:text-lg xl:text-xl bg-blue-900 rounded-lg btn text-white text-gray-500 mt-4">
                Souscrire
                </a>
            </div>
        </div>
