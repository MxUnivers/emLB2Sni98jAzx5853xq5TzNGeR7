...
const CandidatSocial = () => {
    ...
    useEffect(() => {
        ...
        if (candidat && candidat.twitter_url) {
            settwitter_url(candidat.twitter_url)
        }
        if (candidat && candidat.instagram_url) {
            setinstagram_url(candidat.instagram_url)
        }
        if (candidat && candidat.facebook_url) {
            setfacebook_url(candidat.facebook_url)
        }
    }, [candidat])
    ...
    const handleSubmit = (event) => {
        ...
        dispatch(
            CandidatEditSocial(idCandidat, facebook_url,
