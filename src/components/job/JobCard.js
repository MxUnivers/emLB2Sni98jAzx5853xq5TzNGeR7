...
<div
    ...
    <div class="w-48 absolute -top-[5px] -left-20 -rotate-45 bg-blue-800/70">
        ...
        <div class="grid items-center grid-cols-12">
            ...
            <div class="col-span-12 lg:col-span-3">
                <div class="mb-2 mb-md-0">
                    <h5 class="mb-1 fs-18"><a href={`/${routing.job_details}`} onClick={()=> {
                            // setWithExpiration(localvalue.JobID, data._id, dureeDeVie);
                            navigate(`/${routing.job_details}`, { state: { data } });
                            }}
            ...
            <div class="col-span-12 lg:col-span-2">
                <div class="flex flex-wrap gap-1.5">
                    <span class="badge bg-green-500/20 text-green-500 text-13 px-2 py-0.5 font-medium rounded">
        ...
        <div class="grid grid-cols-12">
            ...
            <div class="col-span-3 lg:col-span-2">
                <div class="text-start text-md-end dark:text-gray-50">
                    <a href={`/${routing.job_details}`} onClick={()=> { setWithExpiration(localvalue.JobID, data._id, dureeDeVie)}}
                        data-bs-toggle="modal">Details
                ...
                <div class="text-start text-md-end dark:text-gray-50">
                    <button type="button" onClick={()=> {
                        ...
                        data-bs-toggle="modal"><span>Modifier <MdEdit/> </span>
                    </button>
                </div>
                : null
                }
