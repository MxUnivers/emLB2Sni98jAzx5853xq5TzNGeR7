      ...
      <div class="py-4">
        ...
        <div class="d-flex justify-content-between w-100 flex-wrap">
          <div class="mb-3 mb-lg-0">
            <h1 class="h4">Utlisateurs</h1>
            <p class="mb-0">Liste des utlisateurs qui utilisent l{"'"}application .</p>
          </div>
          <div>
            ...
            <table class="table table-centered table-nowrap mb-0 rounded">
              <thead class="thead-light">
                <tr>
                  ...
                  <th class="border-0">Modifiercation</th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <button type="button" data-bs-toggle="modal" data-bs-target="#modal-form-signup-edit" class="btn btn-sm btn-info d-inline-flex align-items-center">
