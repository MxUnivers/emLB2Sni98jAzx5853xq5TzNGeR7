            ...
            <div class="col-12 col-xxl-6 mb-4">
                <div class="card border-0 shadow">
                    <div class="card-header border-bottom d-flex align-items-center justify-content-between">
                        <h2 class="fs-5 fw-bold mb-0">Tout les membres</h2>
                                    ...
                                    <div class="col text-end">
                                        ...
                                        <div class="dropdown me-1">
                                            ...
                                            <ul class="dropdown-menu py-0 " aria-labelledby="dropdownMenuOffset">
                                                <li>
                                                    <a class="dropdown-item rounded-top" data-bs-toggle="modal" data-bs-target="#modal-form-signup" href="#">Modifier</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item rounded-top" data-bs-toggle="modal" data-bs-target="#modal-form-signup-password" href="#">password</a>
                                                </li>
                                                <li>
