...
import { MemberListRequest } from '../../actions/others/MemberAction';
...
const MemberListPage = () => {
    ...
    useEffect(() => {
        MemberListRequest(setdata, setdataSearch);
    }, []);
    ...
    return (
        <div>
            ...
            <ModalMemberAdd />
            <ModalMemberPassword data={memberdata} />
            <ModalMemberEdit data={memberdata} />
            <ModalMemberAnnonces data={memberdata} />
            <ModalMemberAccess data={memberdata} />
            <ModalMemberStop data={memberdata} />

            <div class="col-12 col-xxl-6 mb-4">
                <div class="card border-0 shadow">
                    <div class="card-header border-bottom d-flex align-items-center justify-content-between">
                        <h2 class="fs-5 fw-bold mb-0">Tout les Candidats</h2>
                                                ...
                                                <div class="col text-end">
                                                    ...
                                                    <div class="dropdown me-1">
                                                        ...
                                                        <ul class="dropdown-menu py-0 " aria-labelledby="dropdownMenuOffset">
                                                            <li>
                                                                <a onClick={()=>handleData(item)} class="dropdown-item rounded-top" data-bs-toggle="modal" data-bs-target="#modal-form-signup-edit" href="#">Modifier</a>
                                                            </li>
                                                            <li>
                                                                <a onClick={()=>handleData(item)} class="dropdown-item rounded-top" data-bs-toggle="modal" data-bs-target="#modal-form-signup-password" href="#">password</a>
                                                            </li>
                                                            <li>
                                                                <a onClick={()=>handleData(item)} class="dropdown-item rounded-top" data-bs-toggle="modal" data-bs-target="#modal-default" href="#">annonces</a>
                                                            </li>
                                                            <li>
                                                                <a onClick={()=>handleData(item)} class="dropdown-item rounded-top text-danger" data-bs-toggle="modal" data-bs-target="#modal-form-signup-stop" href="#">Bloquer</a>
                                                            </li>
                                                            <li>
                                                                <a onClick={()=>handleData(item)} class="dropdown-item rounded-top text-success" data-bs-toggle="modal" data-bs-target="#modal-form-signup-access" href="#">Débloquer</a>
                                                            </li>
                                                        </ul>
                                                    </div>
