                    ...
                    <form onSubmit={handleSubmitOffre}>
                        <div class="row">
                            <div class="col-lg-6 col-md-6">
                                <div class="form-group">
                                    <label>Titre (metier ou besoin ,)</label>
                                    <input required type="text" onChange={handleChangeForm} name="titre" class="form-control" placeholder="Job Title Here" />
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-3">
                                <div class="form-group">
                                    <label>téléphone</label>
                                    <input required type="tel" onChange={handleChangeForm} name="telephone" class="form-control" placeholder="Job Title Here" />
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-3">
                                <div class="form-group">
                                    <label>email</label>
                                    <input required type="email" onChange={handleChangeForm} name="email" class="form-control" placeholder="Job Title Here" />
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="form-group">
                                    <label>Nom de l{"'"}entreprise</label>
                                    <input required type="text" onChange={handleChangeForm} name="entreprise" class="form-control" placeholder="Job Title Here" />
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="form-group">
                                    <label>Description de l{"'"}annonce</label>
                                    <textarea required cols="30" onChange={handleChangeForm} name="description" rows="6" placeholder="Short description..." class="form-control"></textarea>
                                </div>
                            </div>
