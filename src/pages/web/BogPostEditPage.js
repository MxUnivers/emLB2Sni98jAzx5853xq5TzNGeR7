    ...
    return (
        <div className="main-content">
            <div className="page-content mt-28">
                ...
                <div className="h-min-screem heading  text-center font-bold text-2xl m-5 text-gray-800">Mise a jour de votre publication</div>
                <form onSubmit={hanldePostCandidat} className="editor mx-auto mb-28 my-auto w-10/12 flex flex-col text-gray-800  p-10 shadow-lg max-w-2xl">
                    ...
                    <div className=" flex flex-col justify-between">
                        ...
                        <div>
                            <label className="ckncn c9csv cfkm3 ckcgr" for="file">Image post <span className="clvg0">(optional)</span></label>
