        ...
        <div className="fixed inset-0 z-50 bg-black bg-opacity-50 flex items-center justify-center">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg">
                ...
                <form onSubmit={handleSubmitEducation}>
                    ...
                    <input type="text" placeholder="Entreprise/École" value={entreprise_education} onChange={(e)=>
                    setEntrepriseEducation(e.target.value)} className="w-full border rounded mb-4 px-3 py-2" />
