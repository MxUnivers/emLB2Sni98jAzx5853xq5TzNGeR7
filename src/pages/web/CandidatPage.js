                                        ...
                                        <div className="mt-3 text-center sm:mt-0 sm:text-left">
                                            ...
                                            <div className="py-3 px-1 space-y-3">
                                                <div>
                                                    ...
                                                    <input type="text" className="py-2 px-3 rounded-lg border" placeholder='Objet du message' />
                                                </div>

                                                <div>
                                                    <textarea type="text" className="py-2 px-3 rounded-lg border" placeholder='Message' />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
