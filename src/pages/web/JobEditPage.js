                        ...
                        <div className="cyzui">
                            ...
                            <div className="ckjzp c9dke c6to5 cj2th cscbh cyzui coz82 crp1m cx27s">
                                ...
                                <div className="cmdkn cggc7">
                                    ...
                                    <div className="cjplb">
                                        <h1 className="cukoz c4q7l ca00q c7csb">Modifier votre offre </h1>
                                        ...
                                        <div className="c5cvj cmw6a cfqhd">
                                            ...
                                            <div className="cz2ao">
                                                ...
                                                <div className="chva6">
                                                    ...
                                                    <div>
                                                        <label className="ckncn c9csv cfkm3 ckcgr" for="email">Contact Email <span className="ctgjb">*</span></label>
                                                        <input id="email" value={email} onChange={(e) => { setEmail(e.target.value) }} className="cvac0 coz82" type="email" required={true} />
                                                    </div>
                                                    <div>
                                                        <label className="ckncn c9csv cfkm3 ckcgr" for="email">Contact Telehpone <span className="ctgjb">*</span></label>
                                                        <input id="email" value={telephone} onChange={(e) => { setTelephone(e.target.value) }} className="cvac0 coz82" type="number" required={true} />
                                                    </div>

                                                    <div>
                                                        <label className="ckncn c9csv cfkm3 ckcgr" for="email">Addresse de l{"'"}entreprise <span className="ctgjb">*</span></label>
                                            ...
                                            <div className="cz2ao">
                                                ...
                                                {
                                                    /*<div className="cixlf">
                                                    <div className="clvg0 cwe8x">By clicking pay you agree to our <a className="c5xyh" href="#0">Terms of Service</a> and <a className="c5xyh" href="#0">Privacy Policy</a>.</div>
                                                </div> */
                                                }
                                            </div>
                                        </div>
