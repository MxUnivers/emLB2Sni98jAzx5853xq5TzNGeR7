...
import BarnerSignup from '../../../components/web/auth/BarnerSignup';
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-white shadow-md rounded-lg px-8 pt-6 pb-8 mb-4">
            ...
            <a href={`/${routing.inscriptionCandidat.path}`} className="bg-indigo-500 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded-full">
              Inscription
            </a>
          </div>
          <div className="bg-white shadow-md rounded-lg px-8 pt-6 pb-8 mb-4">
            ...
            <a href={`/${routing.inscriptionEmployer.path}`} className="bg-indigo-500 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded-full">
              Insciption
            </a>
          </div>
        </div>
