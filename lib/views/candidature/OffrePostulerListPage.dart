...
class OffrePostulerListPage extends StatefulWidget {
  const OffrePostulerListPage({Key? key}) : super(key: key);

  @override
  State<OffrePostulerListPage> createState() => _OffrePostulerListPageState();
}

class _OffrePostulerListPageState extends State<OffrePostulerListPage> {
  ...
  Future<List<dynamic>> _getCandidatiures() async {
    ...
    final String apiUrl = '${baseurl["url"].toString()}/api/v1/candidat/get_candidat/${id}/offres';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          title: Text("Offres postulées (${candidatures.length.toString()})"),
          centerTitle: true,
