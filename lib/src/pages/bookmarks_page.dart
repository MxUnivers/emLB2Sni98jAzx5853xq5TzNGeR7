...
class JobBookmarkPage extends StatefulWidget {
  ...
  JobBookmarkPage({Key? key, this.title, required this.store}) : super(key: key);
    ...
    return PageView(physics: NeverScrollableScrollPhysics(), children: [
      Scaffold(
        ...
        appBar:AppBar(
          ...
          title: Container(
            height: 45,
            child: Text("Offre enregistrés ",style:GoogleFonts.nunito(color: AppTheme_App.withGreyOrginal))
          ),
        ),
        body: Container(
