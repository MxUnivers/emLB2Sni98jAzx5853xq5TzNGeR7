...
class _PostDetailPageState extends State<PostDetailPage> {
  ...
  late CandidatModel candidat = CandidatModel(
      account: AccountCandidatModel(
          pack: "", dateEnd: "", countSms: 0, dateNow: "", solde: 0));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: candidat.account!.pack.toString() == "DIAMOND"
            ? Container(
                    ...
                    child: Container(
                      ...
                      Container(
                          ...
                          child: CachedNetworkImage(
                            imageUrl:
                                widget.postdetail!.coverPicture.toString(),
                          ...
                          if (commentController.text.length > "".length) {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                ...
                                content: Text("Champ de commentaire est vide",
                                    style: GoogleFonts.nunito(
                                        color: AppTheme_App.withPrimary),
