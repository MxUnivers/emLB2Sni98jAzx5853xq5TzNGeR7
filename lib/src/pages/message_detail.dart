...
import 'package:jouman_mobile_mobile/src/actions/EntrepriseAction.dart';
...
class _MessageDetailPageState extends State<MessageDetailPage> {
  ...
  Widget build(BuildContext context) {
    final formattedDateTime = formatDateTime(widget.message!.createdAt.toString());
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Détails du message',style: GoogleFonts.nunito(color: AppTheme_App.TextGray),),
        elevation: 0.2,
      ),
      body: Container(
